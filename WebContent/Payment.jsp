		...
		<div class="box">
			...
			<% String reservationIdString = request.getParameter("reservationId");
               if(null==reservationIdString){
            	   request.setAttribute(Constants.ERR_MSG_ATTR_NAME, "Липсва параметър в заявката с име 'reservationId'");
               ...
               if(reservation == null){
            	   request.setAttribute(Constants.ERR_MSG_ATTR_NAME, "Не съществува резервация с ID " + reservationId);
            	   request.getRequestDispatcher("error.jsp").forward(request, response);
            	   return;
               }
